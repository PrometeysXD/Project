...
txt={"/1/2":"Как вы знаете, одно и то же вещество в зависимости от внешних условий может находиться в одном из агрегатных состояний: жидком, твёрдом или газообразном. Как определить, что находится в стакане: вода или прозрачный лёд? Для этого необходимо использовать информацию о свойствах вещества в различных агрегатных состояниях. Вы же помните, что жидкости сохраняют объём, но не форму — они текучи и приобретают форму того сосуда, в который их переливают. Особенностью твёрдых тел является наличие собственного объёма и формы. Газы не обладают ни собственной формой, ни собственным объёмом. Они занимают весь предоставленный им объём, принимая форму сосуда. Газы легко сжать. Во всех трёх агрегатных состояниях вещество, например вода, образовано одинаковыми молекулами — молекулами воды. Почему же одно и то же вещество может быть и жидкостью, и твёрдым телом, и газом? Как вам известно, молекулы вещества взаимодействуют друг с другом, а также совершают непрерывное хаотическое движение. Можно предположить, что существование различных агрегатных состояний связано с особенностями взаимодействия и движения молекул вещества. Представим, что молекулы только беспорядочно движутся и при этом не взаимодействуют. Тогда они разлетались бы по всем направлениям, и вещество занимало бы весь предоставленный объём. Значит, единственно возможным состоянием вещества было бы газообразное состояние. А к чему приводит наличие взаимодействия между молекулами? Вы знаете, что молекулы взаимодействуют друг с другом силами притяжения и отталкивания, причём проявляется это взаимодействие на малых расстояниях. Так, если молекулы находятся на расстояниях, превышающих их размеры в несколько раз, то силы взаимодействия между ними уже почти не сказываются. Итак, существует некоторое равновесное расстояние между молекулами данного вещества, на котором силы отталкивания равны силам притяжения. Если расстояние между молекулами больше равновесного, то преобладают силы притяжения, если меньше — силы отталкивания. Представим, что хаотическое движение молекул отсутствует. Тогда все молекулы располагались бы в положениях равновесия и единственно возможным состоянием вещества было бы твёрдое состояние. Но молекулы взаимодействуют и движутся одновременно. Силы притяжения стремятся сблизить их, а хаотическое движение препятствует этому. Быть ли телу газообразным, жидким или твёрдым, зависит от соотношения этих факторов. В газах молекулы быстро движутся и почти не взаимодействуют, в твёрдых телах, наоборот, взаимодействие молекул велико, а движутся они медленно. Промежуточный случай соответствует жидкости. Опишем агрегатные состояния с молекулярной точки зрения более подробно и дадим объяснение их свойствам. В газах среднее расстояние между молекулами значительно больше их размеров. На таких расстояниях силы взаимодействия молекул почти отсутствуют. Поэтому вещество в газообразном состоянии не сохраняет ни форму, ни объём. Бо́льшую часть времени каждая молекула движется прямолинейно, затем меняет направление движения в результате столкновения с другой молекулой. В отличие от газов в жидкостях молекулы находятся близко друг к другу. Взаимодействие между молекулами достаточно велико для того, чтобы объём жидкости оставался постоянным, но не достаточно велико для сохранения жидкостью формы. Положения молекул жидкости относительно друг друга не фиксированы. Совершив несколько десятков—сотен колебаний около некоторого положения равновесия, молекула скачком меняет его на новое и колеблется рядом с новыми соседями. В твёрдых телах молекулы находятся друг от друга на расстояниях, близких к размерам молекул, и колеблются около положений равновесия. В случае попытки увеличить или уменьшить расстояние между молекулами возникают значительные силы их притяжения или отталкивания. Этим объясняется, что твёрдые тела сохраняют форму и объём. Молекулы и атомы большинства веществ в твёрдом состоянии расположены в строго определённом порядке, образующем повторяющуюся структуру — кристаллическую решётку. Такое состояние вещества называют кристаллическим. Места нахождения атомов называют узлами кристаллической решётки. Бывают решётки, «составленные» из кубиков, параллелепипедов и т. п. Кристаллическое строение имеют поваренная соль, лёд, алмаз, железо и т. д. Существует твёрдое состояние вещества, для которого характерно отсутствие кристаллической решётки и в целом беспорядочное расположение молекул (атомов). Это аморфное состояние. У вещества в аморфном состоянии порядок во взаимном расположении атомов наблюдается только в небольшой области вблизи каждого атома и с увеличением расстояния исчезает. В природе в аморфном состоянии могут находиться опал, янтарь, смолы и т. д. Вещества в аморфном состоянии, как и жидкости, текучи, только текут они очень медленно.",
     "/1/3":"В предыдущей теме, говоря об агрегатных состояниях, мы рассматривали взаимодействие молекул одного и того же вещества, однако взаимодействуют и молекулы разных веществ: так, если на поверхность воды положить стеклянную пластину и тянуть за прикреплённую к ней пружину, то оторванная от воды пластина будет покрыта водой, что означает, что разрыв происходит между слоями воды, а не между водой и стеклом, то есть притяжение между молекулами воды меньше, чем притяжение между молекулами воды и стекла, при этом некоторые вещества вода может и не смачивать, например, жирные поверхности, что видно на примере перьев водоплавающих птиц, которые выходят из воды сухими благодаря жировой плёнке, тогда как нефть смачивает перья, приводя к намоканию и опасности для птиц, также вода не смачивает поверхности, покрытые воском, как на листьях растений, где восковой налёт защищает устьица от воды, итак, если притяжение между молекулами поверхности твёрдого тела и жидкости больше, чем притяжение молекул жидкости между собой, то жидкость смачивает поверхность, растекаясь по ней, что называют смачиванием и используют, например, при вытирании рук полотенцем или в красильном производстве, а если притяжение между молекулами поверхности и жидкости меньше, чем внутри жидкости, то жидкость не смачивает поверхность, собираясь в капли, что можно наблюдать на траве рано утром.",
     "/1/4":"В повседневной жизни температура для нас — это величина, характеризующая, насколько нагреты те или иные тела. Каждый из вас может отличить тёплое от холодного, горячее от тёплого. Явления, важной характеристикой которых является температура, называют тепловыми. К таким явлениям относятся, например, нагревание и охлаждение воды, образование льда, плавление парафина. Проведём опыт. Опустим одну руку в сосуд с горячей водой, а другую в сосуд с холодной водой и подержим их там в течение некоторого времени. Затем перенесём обе руки в сосуд с тёплой водой. Каковы будут наши ощущения? Одна рука почувствует холод, другая — тепло. Однако через некоторое время обе руки начнут испытывать одинаковые ощущения, соответствующие температуре воды в третьем сосуде. Перед погружением в третий сосуд руки имели разные температуры, отличающиеся от температуры воды в сосуде. Однако по прошествии времени температуры всех тел стали одинаковыми. Рассмотренный опыт иллюстрирует важную особенность температуры: если несколько тел различной температуры привести в соприкосновение друг с другом, то через некоторое время температура всех тел станет одинаковой. В таком случае говорят, что в системе тел установилось тепловое равновесие. На достижении теплового равновесия основана процедура измерения температуры. Температуру измеряют с помощью термометра. Вспомните, как вы измеряете температуру собственного тела медицинским термометром (в быту его называют градусником) — зажимаете его под мышкой. Вначале термометр холодит тело, затем ощущение холода исчезает. Через 10 мин вы вынимаете термометр и смотрите, какую температуру он показывает. Температуру чего показывает термометр? Ответ вам кажется очевидным: температуру вашего тела. Но не торопитесь. Он показывает собственную температуру. Мы помещаем термометр под мышку для того, чтобы привести его в плотное соприкосновение с телом, тогда температура термометра через небольшой промежуток времени станет равной температуре нашего тела. Между телом и термометром устанавливается тепловое равновесие. Термометр содержит рабочее вещество, свойства которого изменяются при изменении температуры. Так, принцип действия жидкостного термометра основан на расширении жидкостей при нагревании. Приходя в тепловое равновесие с телом, температура которого измеряется, жидкость изменяет свой объём. О температуре тела судят по длине столбика жидкости. Как только вы достали из-под руки термометр, его температура должна понизиться, приближаясь к температуре окружающего воздуха. Но показания термометра не меняются, потому что в его капилляре сделано специальное сужение, которое разрывает столб ртути, не давая ей опускаться. Таким образом, медицинский термометр фиксирует максимальную температуру, поэтому его называют максимальным. Другие термометры, не имеющие такого сужения, до снятия показаний нельзя вынимать из среды, температуру которой они измеряют. Чтобы по длине столбика жидкости можно было определять температуру, термометр должен иметь шкалу. Одной из наиболее распространённых в практике температурных шкал является шкала Цельсия, названная в честь шведского учёного Андерса Цельсия (1701—1744), предложившего её в 1742 г. Шкала Цельсия основана на двух фиксированных значениях температуры — таяния льда и кипения воды при нормальном атмосферном давлении. Температура по шкале Цельсия обозначается буквой t и измеряется в градусах Цельсия. Чтобы получить шкалу термометра, опустим его в тающий лёд и, дождавшись, когда столбик жидкости прекратит движение, обозначим его положение отметкой 0 °С. Затем погрузим термометр в кипящую воду и сделаем отметку 100 °С. Разделив промежуток между этими двумя отметками на 100 одинаковых частей, получим термометр, проградуированный по шкале Цельсия. Перемещение столбика жидкости на одно деление соответствует изменению температуры на 1 °С. Прообраз термометра (термоскоп) был изобретён уже к началу XVII в. К середине XVIII в. термоскопы стали термометрами — они были снабжены шкалами, и учёные получили возможность определять числовое значение температуры. Но что же характеризует температура? Правильный ответ на этот вопрос появился только в середине XIX в. Как вы знаете, с ростом температуры жидкости броуновские частицы начинают двигаться быстрее. Значит, при повышении температуры быстрее движутся молекулы жидкости, толкающие броуновские частицы. Именно поэтому беспорядочное движение молекул называют тепловым. Отличие механического движения от теплового заключается в том, что механическое движение совершает отдельная частица и для любого момента времени можно определить её положение и скорость. В тепловом же движении участвует огромное число молекул, и зафиксировать информацию о положении и скорости каждой из них просто невозможно. Изучая тепловое движение, вводят характеристики, относящиеся не к отдельным частицам, а к совокупностям большого числа частиц. В процессе установления теплового равновесия горячие тела остывают, холодные нагреваются и в результате их температуры выравниваются. А что это означает с молекулярной точки зрения? Молекулы тел при столкновениях обмениваются между собой энергией. За счёт бесчисленных столкновений средние кинетические энергии молекул соприкасающихся тел выравниваются. Итак, когда тела приходят в тепловое равновесие и принимают одинаковую температуру, средние кинетические энергии их молекул становятся одинаковыми. Таким образом, температура характеризует среднюю кинетическую энергию теплового движения молекул. Подчеркнём, что температура характеризует тело в целом, среднюю кинетическую энергию огромного числа молекул, а не отдельную молекулу. Молекулы тела совершают беспорядочное движение, их скорости и кинетические энергии изменяются. Средняя же кинетическая энергия молекул при данной температуре остаётся неизменной. Увеличение средней кинетической энергии молекул воспринимается нами как повышение температуры тела, а уменьшение — как её понижение. Если бы молекулы перестали двигаться, то кинетическая энергия каждой молекулы, а значит, и средняя кинетическая энергия молекул были бы равны нулю. Температуру, при которой в теле прекратилось бы тепловое движение, называют абсолютным нулём. Меньшей температуры в природе не существует. По шкале Цельсия абсолютный нуль равен –273,15 °С. Абсолютный нуль служит началом отсчёта температурной шкалы Кельвина, названной по имени британского физика Томсона Уильяма Кельвина (1824—1907). Эту шкалу используют в научных исследованиях. Температура по шкале Кельвина обозначается буквой T. Единицей температуры по этой шкале является кельвин (К). Для разности температур один кельвин равен одному градусу Цельсия: 1 К = 1 °С. Поскольку по шкале Цельсия абсолютному нулю соответствует температура –273,15 °С (при вычислениях округляют до –273 °С), то связь температур по шкале Кельвина и по шкале Цельсия выражается соотношением: T = t + 273."}
anw={"/1/2/test":["твёрдое","жидкое","газообразное"],"/1/3/test":[]}
...
def main(pagew: ft.Page):
    ...
    tests={"/1/2":["Налейте в пластиковую бутылку немного холодной воды и поместите её в морозильную камеру на несколько часов, чтобы образовался лёд. Затем, вынув бутылку со льдом, добавьте в неё воды. Внутри будет находиться вода одновременно в трёх состояниях. Какие это состояния?"],
           "/1/3":["Обезжиривание металла перед покраской необходимо для улучшения смачивания, так как жирная поверхность отталкивает краску, не позволяя ей равномерно растекаться и прочно сцепляться с материалом.","Масло, пропитавшее ткань, создаёт на её поверхности водоотталкивающий слой, который не смачивается водой, из-за чего вода не может проникнуть через волокна.","Поговорка «Как с гуся вода» основана на явлении несмачивания: перья водоплавающих птиц покрыты жиром, из-за чего вода скатывается с них в виде капель, не впитываясь и не смачивая поверхность.","На сыром грунте следы от шагов намокают из-за капиллярного эффекта: при надавливании уплотнённая почва сильнее подтягивает воду из нижних слоёв через мелкие поры-капилляры, делая поверхность более влажной."]}
    def goto_pagew2(n):
    ...
    def goto_test_end(n):
        if txtf.value.lower().split(",").sort() == anw[pagew.route].sort() and txtf.value != "":
            print(txtf.value)
            print(anw[pagew.route])
            pagew.go("/")
        elif txtf1.value.lower().split(",").sort == anw[pagew.route].sort() and txtf1!= "" and txtf2.value.lower().split(",").sort == anw[pagew.route].sort() and txtf2!= "" and txtf3.value.lower().split(",").sort == anw[pagew.route].sort() and txtf3!= "" and txtf4.value.lower().split(",").sort == anw[pagew.route].sort() and txtf4!= "":
            pagew.go("/")
    ...
    txtf1 = ft.TextField(label="Ответ",border=ft.InputBorder.UNDERLINE,border_color=ft.Colors.PRIMARY,hint_text="Пишите только запятые без пробелов")
    txtf2 = ft.TextField(label="Ответ",border=ft.InputBorder.UNDERLINE,border_color=ft.Colors.PRIMARY,hint_text="Пишите только запятые без пробелов")
    txtf3 = ft.TextField(label="Ответ",border=ft.InputBorder.UNDERLINE,border_color=ft.Colors.PRIMARY,hint_text="Пишите только запятые без пробелов")
    txtf4 = ft.TextField(label="Ответ",border=ft.InputBorder.UNDERLINE,border_color=ft.Colors.PRIMARY,hint_text="Пишите только запятые без пробелов")
    ...
    def route_change(e):
        ...
        for i in range(2,27):
            if pagew.route == "/1/"+str(i):
                ...
                pagew.views.append(
                    ft.View(
                    "/1/"+str(i),[ft.AppBar(title=ft.Text(b["/1/"+str(i)], theme_style=ft.TextThemeStyle.DISPLAY_LARGE),center_title=True),ft.Text(value=txt["/1/"+str(j)],theme_style=ft.TextThemeStyle.TITLE_LARGE,weight=300),ft.TextButton("Приступить к тестированию",on_click=goto_test)]
                    )
                )
        ...
        for i in range(2,27):
            if pagew.route == "/1/"+str(i)+"/test":
                if i==2 or i == 3:
                    j=i
                pgs = {"/1/2/test":[ft.AppBar(title=ft.Text("Тестирование по теме "+b["/1/"+str(i)], theme_style=ft.TextThemeStyle.DISPLAY_LARGE),center_title=True),ft.Text(value=tests["/1/2"][0],theme_style=ft.TextThemeStyle.HEADLINE_SMALL),txtf,ft.TextButton("Закончить тестирование",on_click=goto_test_end)],
                "/1/3/test":[ft.AppBar(title=ft.Text("Тестирование по теме "+b["/1/"+str(i)], theme_style=ft.TextThemeStyle.DISPLAY_LARGE),center_title=True),ft.Text(value=tests["/1/3"][0],theme_style=ft.TextThemeStyle.HEADLINE_SMALL),txtf1,ft.Text(value=tests["/1/3"][1],theme_style=ft.TextThemeStyle.HEADLINE_SMALL),txtf2,ft.Text(value=tests["/1/3"][2],theme_style=ft.TextThemeStyle.HEADLINE_SMALL),txtf3,ft.Text(value=tests["/1/3"][3],theme_style=ft.TextThemeStyle.HEADLINE_SMALL),txtf4,ft.TextButton("Закончить тестирование",on_click=goto_test_end)]}

                pagew.views.append(
                    ft.View(
                    "/1/"+str(i)+"/test",pgs["/1/"+str(j)+"/test"]
                    )
                )
        for i in range(27,50):
